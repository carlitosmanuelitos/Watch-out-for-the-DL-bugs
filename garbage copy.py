...
class Enhanced_Linear_Regression(BaseModel_ML):
    ...
    def _initialize_model(self):
        ...
        if self.config['regularization'] == 'ridge':
            ...
            logging.info("Ridge regression model initialized.")
        elif self.config['regularization'] == 'lasso':
            self.model = Lasso(alpha=self.config['alpha'])
            logging.info("Lasso regression model initialized.")
        else:
            self.model = LinearRegression()
            logging.info("Plain Linear Regression model initialized.")
...
class Enhanced_XGBoost(BaseModel_ML):
    ...
    def _initialize_model(self):
        ...
        logging.info("XGBoost model initialized.")
    ...
    def make_predictions(self):
        ...
        try:
            self.train_predictions = self.model.predict(self.X_train)
            self.test_predictions = self.model.predict(self.X_test)
            logging.info("Predictions made successfully for both training and test data")
        except Exception as e:
            logging.error(f"Error occurred while making predictions: {str(e)}")        
...
class Enhanced_LightGBM(BaseModel_ML):
    ...
    def _initialize_model(self):
        ...
        logging.info("LightGBM model initialized.")
...
class Enhanced_KNN(BaseModel_ML):
    ...
    def _initialize_model(self):
        ...
        logging.info("KNN model initialized.")
...
class Enhanced_ExtraTrees(BaseModel_ML):
    ...
    def _initialize_model(self):
        ...
        logging.info("Extra Trees model initialized.")
...
def run_models(models, data_preprocessor, run_only=None, skip=None):
    for name, model_info in models.items():
        ...
        model = model_class(data_preprocessor, config)
        model.train_model()
